...
export const AlgoliaHighlightResult = z
  .object({
    name: z
      .object({
...
export const SGRegisterBusinessAddress = z
  .object({
...
export const SGRegisterApprovalArea = z
  .object({
    subject_area: z.string().nullable().optional(),
  })
  .nullable();

export const SGRegisterStatus = z
  .object({
...
export const BrregOrganisasjonsform = z
  .object({
...
export const BrregNaeringskode = z
  .object({
    beskrivelse: z.string().nullable().optional(),
  })
  .nullable()
...
export const RegnskapsperiodeSchema = z
  .object({
...
export const DriftsinntekterSchema = z
  .object({
...
export const DriftsresultatSchema = z
  .object({
...
export const ResultatregnskapResultatSchema = z
  .object({
...
export const EiendelerSchema = z
  .object({
...
export type SGRegisterEnterpriseType = z.infer<typeof SGRegisterEnterprise>;
export type BrregResponseType = z.infer<typeof BrregResponse>;
export type RegnskapsregisterResponseType = z.infer<
  typeof RegnskapsregisterResponse
>;
